<?php
echo '<title>Weared - Service One</title><body><center><img src="https://i.imgur.com/gqV8Nz7.png"></center></body>';
echo '<style>
body {
  background-image: url(\'https://i.imgur.com/1RkKhPu.jpg\');
}
</style>';
...
$config  = array(
    ...
    // Sicurezza
    "automatic_username_check" => false, //Controlla automaticamente se l'username del bot è corretto,per migliori prestazioni è consigliato disabiltarlo e abilitare bot_username.
    "bot_username" => array( //Per maggiore sicurezza inserisci gli username dei tuoi bot che sono collegati al webhook,ciò eviterà cloni
        "allowed_usernames" => array("WearedService_bot"), //username dei vari bot,SONO CASE-SENSITIVE
    ...
    "user" => "weared", //se non usi altervista inserisci il nome utente del DB
    "password" => "", //se non usi altervista inserisci la password di mysql
    "database" => "my_weared", //se non usi altervista inserisci il nome del database
    //TELEGRAM
    "show_update" => false,
